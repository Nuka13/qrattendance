...
const App: React.FC = () => {
  ...
  const formUrl = sessionId && randomPath
    ? `${window.location.origin}/test-submit?sessionId=${encodeURIComponent(sessionId)}`
    : "";
